...
class Game {
	...
	public:
		...
		double calcTransProb(int stateInitial, int action, int stateFinal);		//checked			// Transition probability from one state to another based on the action carried out.
